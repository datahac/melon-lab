...
const RiskProfileFormContainer = withForm(props => {
  ...
  return (
    <RiskProfile {...props} onActivatePolicy={props.onActivatePolicy} availablePolicies={availablePolicies(tokens)} />
  );
});
...
const RiskProfileContainer = ({ ...props }) => {
  ...
  return (
    <Composer components={[<TokensQuery />, <FundPoliciesQuery address={props.address} />]}>
