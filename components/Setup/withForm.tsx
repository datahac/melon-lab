...
const withForm = withFormik({
  ...
  validationSchema: props =>
    Yup.object().shape({
      ...(props.page === 0
        ? {
            name: Yup.string()
              ...
              .test('is-unique', 'There is already a fund with this name', async value => {
                if (value) {
      ...
      ...(props.page === 3
        ? {
            terms: Yup.boolean().test('is-checked', 'Must Accept Terms and Conditions', value =>
...
const withFormHandlers = withHandlers({
  ...
  onChangeExchanges: props => event => {
    ...
    if (!exchanges.includes(value)) {
      ...
      props.setFieldValue('exchanges', [...exchanges.filter(item => item !== value)]);
    }
  },
