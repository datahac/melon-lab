  ...
  <div className="conditions">
    <Fragment>
      ...
      <p>
        ...
        COMPLIANCE WITH APPLICABLE LAW. <b>FAILURE TO DO SO MAY SUBJECT YOU TO
        CRIMINAL AS WELL AS CIVIL PENALTIES IN ONE OR MORE JURISDICTIONS.</b> BY
        USING THIS SOFTWARE, YOU CONFIRM THAT YOU HAVE SOUGHT THE ADVICE OF
