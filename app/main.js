...
/* harmony import */ var _shared_graphql_schema__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ~/shared/graphql/schema */ "./src/shared/graphql/schema/index.ts");
/* harmony import */ var _shared_graphql_schema_context__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ~/shared/graphql/schema/context */ "./src/shared/graphql/schema/context.ts");
/* harmony import */ var _shared_graphql_schema_environment__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ~/shared/graphql/schema/environment */ "./src/shared/graphql/schema/environment/index.ts");
/* harmony import */ var _shared_graphql_server__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ~/shared/graphql/server */ "./src/shared/graphql/server.ts");
...
function () {
  ...
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var environment, wallet, context, link, handleRedirect, next, requestHandler, appUrl;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Object(_shared_graphql_schema_environment__WEBPACK_IMPORTED_MODULE_8__["getEnvironment"])();

          case 2:
            environment = _context.sent;
            _context.next = 5;
            return Object(_shared_graphql_schema_environment__WEBPACK_IMPORTED_MODULE_8__["getWallet"])();

          case 5:
            wallet = _context.sent;
            _context.next = 8;
            return Object(_shared_graphql_schema_context__WEBPACK_IMPORTED_MODULE_7__["createContext"])(environment, wallet);

          case 8:
            context = _context.sent;
            link = Object(_shared_graphql_server__WEBPACK_IMPORTED_MODULE_9__["createSchemaLink"])({
              schema: _shared_graphql_schema__WEBPACK_IMPORTED_MODULE_6__["schema"],
              context: context
            });
            Object(_shared_graphql_server__WEBPACK_IMPORTED_MODULE_9__["createIpcExecutor"])({
              link: link,
              ipc: electron__WEBPACK_IMPORTED_MODULE_1__["ipcMain"]
