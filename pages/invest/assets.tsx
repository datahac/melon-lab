...
import checkIsManager from '~/utils/checkIsManager';
...
export default class InvestAssetsPage extends React.Component {
  static async getInitialProps(context) {
    ...
    const isValidFund = await checkIsManager(context.apolloClient, parameters.address);
  ...
  render() {
    ...
    return (
      <InvestTemplate title="Allowed subscription assets" address={this.props.address}>
