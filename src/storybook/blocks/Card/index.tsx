        ...
        <div className="card__info-wrap">
          ...
          <div className="card__info">
            <div className="card__share-price">
              <span className="card__label">Share price</span> {sharePrice && displayPrice(sharePrice, decimals)}
            </div>
            <div className="card__aum">
              <span className="card__label">AUM</span> {gav && displayQuantity(gav, decimals)}
            </div>
            <div className="card__inception-date">
              <span className="card__label">Inception Date</span> {format(inception, 'DD. MMM YYYY HH:mm')}
            </div>
          </div>
        </div>
      </div>
