  ...
  <div className="fonts">
    ...
    {Object.keys(typography.fontSizes).map(key => (
      <div key={key} className="fonts__row">
        <div className="fonts__col" style={{ fontSize: typography.fontSizes[key] }}>
          {key}
        </div>
        <div className="fonts__col" style={{ fontSize: typography.fontSizes[key] }}>
...
const FontFamilies = () => (
  <div className="fonts">
    ...
    {Object.keys(typography.fontFamilies).map(key => (
      <div key={key} className="fonts__row">
        <div className="fonts__col" style={{ fontFamily: typography.fontFamilies[key] }}>
          {key}
        </div>
        <div className="fonts__col" style={{ fontFamily: typography.fontFamilies[key] }}>
...
const FontWeights = () => (
  <div className="fonts">
    ...
    {Object.keys(typography.fontWeights).map(key => (
      <div key={key} className="fonts__row">
        <div className="fonts__col" style={{ fontWeight: typography.fontWeights[key] }}>
          {key}
        </div>
        <div className="fonts__col" style={{ fontWeight: typography.fontWeights[key] }}>
