      ...
      <Fragment>
        {currentAddress && (
          <Fragment>
            ...
            {associatedFund && isComplete && <AssociatedFund associatedFund={associatedFund} networkId={networkId} />}
...
const AssociatedFund = ({ associatedFund, networkId }) => (
  <Fragment>
    ...
    <p>
      ...
      <strong>
        <a
          href={`https://${networkId === 'KOVAN' ? 'kovan.' : ''}etherscan.io/address/${associatedFund}`}
          target="_blank"
        >
          {associatedFund}
        </a>
