...
export const Policies: StatelessComponent<PoliciesProps> = ({
  ...
  const activePolicies = R.intersection(Object.keys(availablePolicies), Object.keys(values.policies));

  const inactivePolicies = R.difference(Object.keys(availablePolicies), Object.keys(values.policies));
              ...
              <div className="policies__item" key={item}>
                <div className="policies__item-wrap policies__item-wrap--active">
                  ...
                  <policy.Component
                    ...
                    onBlur={handleBlur}
                    error={isTouched && !!errors.policies && errors.policies[item]}
                    centerText
                  />
                  <div className="policies__item-desc">{policy.desc}</div>
                  <div className="policies__item-remove">
                    <Button style="danger" onClick={() => onActivatePolicy(item)} size="small">
                      Deactivate
                    </Button>
                  </div>
                </div>
