...
export const InsufficientFunds: StatelessComponent<InsufficientFundsProps> = ({ eth, address }) => (
  <Notification isWarning={true}>
    ...
    <Link target="_blank" style="secondary" size="medium" href={`https://faucet.melon.fund/?address=${address}`}>
      Go to faucet
    </Link>
  </Notification>
);
