    ...
    estimations={[
      {
        ...
        variables: props.values && {
          ...
          performanceFee: R.path(['values', 'fees', 'performanceFee'], props).toString(),
          managementFee: R.path(['values', 'fees', 'managementFee'], props).toString(),
      ...
      },
      {
        ...
        isComplete: !!props.fund && !props.setup.setupComplete && !props.setup.setupInProgress,
        name: 'setupComplete',
      },
    ]}
    executions={[
        ...
        update: cache => {
          ...
          if (R.isEmpty(R.path(['values', 'policies'], props))) {
            props.router.push({
              ...
              query: {
                address: props.fund,
                destination: encodeURI(`/invest?address=${props.fund}`),
              },
            });
          }
        },
