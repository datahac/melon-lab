...
const GetStartedContainer = ({ ...props }) => (
  <Composer components={[<AccountConsumer />, <BalanceConsumer />, <FundManagerConsumer />, <SetupConsumer />]}>
    {([account, balance, managerProps, setupProps]) => {
      const link = getLink(account, balance.eth, managerProps.fund, setupProps.isComplete);
