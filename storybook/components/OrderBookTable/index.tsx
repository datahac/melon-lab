    ...
    <div className={orderBookTableClassNames}>
      ...
      <div className="orderbook-table__head">
        <div className="orderbook-table__head-row">
          <div className="orderbook-table__head-cell">{style === 'sell' ? 'Ask' : 'Bid'}</div>
      ...
      <div className="orderbook-table__body">
        {entries.map((order, index) => {
          ...
          return (
            ...
            >
              <div className="orderbook-table__body-cell">{Tm.toFixed(order.trade, 6)}</div>
              <div className="orderbook-table__body-cell">{Tm.toFixed(order.trade.base, 6)}</div>
              <div className="orderbook-table__body-cell">{Tm.toFixed(order.cummulative, 6)}</div>
