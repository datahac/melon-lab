  ...
  return (
    <Fragment>
      ...
      {(!loading && !allowedAssets.length && (
        <Notification isWarning>This fund does not currently allow investment.</Notification>
      )) ||
        null}
        ...
        <div className="participation-form">
          {(isWaiting && !isExpired && (
            <Notification isWarning>
              ...
              update and within 24 hours from now, in order to execute that investment request. Please note this
              investment request may be executed by another party as well.
            </Notification>
          )) ||
            null}
          ...
          {(readyToExecute && (
            <Fragment>
              <Notification isWarning>Execute your investment request!</Notification>
              <hr />
          ...
          {!loading && !isWaiting && !readyToExecute && (
            <Form onSubmit={handleSubmit}>
              ...
              <div className="participation-form__current-price">
                <span>Current share price: {sharePrice && Tm.toFixed(sharePrice)}</span>
              </div>
              ...
              <div className="participation-form__input">
                <Input
                  ...
                  type="number"
                  label={`Max price (${R.path(['quote', 'token', 'symbol'], values.price)})`}
                  name="price"
                  insideLabel
                  placeholder={numberPlaceholder}
                  onChange={handleChange}
