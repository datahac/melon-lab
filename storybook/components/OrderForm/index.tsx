  ...
  return (
    <div className="order-form">
      ...
      <Form onSubmit={handleSubmit}>
        {!priceFeedUp && <Notification isWarning={true}>Trading not possible when price feed down</Notification>}
        ...
        <div className="order-form__switch">
          <Switch
            options={[R.path(['token', 'symbol'], baseToken), R.path(['token', 'symbol'], quoteToken)]}
            labels={['Buy', 'Sell']}
            onChange={onChange}
            name="type"
            value={values.type}
        ...
        <div className="order-form__order-info">
          <OrderInfo baseToken={baseToken} quoteToken={quoteToken} lastPrice={lastPrice} ask={ask} bid={bid} />
        </div>
        ...
        <div className="order-form__input">
          <Input
            ...
            disabled={(isMarket && !isKyber && !isMelonEngine && !values.price) || !priceFeedUp || !isManager}
          />
        </div>
        <div className="order-form__input">
          <Input
        ...
        <Button disabled={(isMarket && !values.price) || !priceFeedUp || !isManager} type="submit">
          {values.type}
        </Button>
      </Form>
    </div>
