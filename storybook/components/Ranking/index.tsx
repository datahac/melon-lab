      ...
      <div className="ranking__table-wrap">
        <div className="ranking__filters">
          <div className="ranking__search">
            <Input name="search" placeholder="Search fund" value={search} onChange={e => setSearch(e.target.value)} />
          </div>
        ...
        {funds.length > 0 ? (
          <div className="ranking__funds">
            {funds.map(fund => (
              <Link key={fund.address} href={`/manage?address=${fund.address}&base=MLN&quote=WETH`}>
