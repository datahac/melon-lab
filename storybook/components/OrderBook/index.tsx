...
export const OrderBook: StatelessComponent<OrderBookProps> = ({
  ...
  return (
    <div className="orderbook">
        ...
        <div className="orderbook__exchanges">
          ...
          <div className="orderbook__exchange">
            <Checkbox
              ...
              defaultChecked={selectedExchanges.length === availableExchanges.length}
            />
          </div>
      ...
      {!loading && bids.length === 0 && asks.length === 0 && (
        <Notification isWarning>No orders on the orderbook for this trading pair</Notification>
      )}

      {(bids.length !== 0 || asks.length !== 0) && (
        <Fragment>
          <div className="orderbook__tables">
            <OrderBookTable style="buy" entries={bids} onClickOrder={isManager && setSellOrder} canTrade={isManager} />
            <OrderBookTable style="sell" entries={asks} onClickOrder={isManager && setBuyOrder} canTrade={isManager} />
          </div>
        </Fragment>
      )}
    </div>
